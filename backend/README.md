...
## Project Structure
    ...
    ├── easy_expense_manage_33029  # Django project configurations
...
1. Clone this repo and `cd easy_expense_manage_33029`
...
2. Clone this repo and `cd easy_expense_manage_33029`
